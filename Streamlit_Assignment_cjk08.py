...
# First Visualization setup: Average Salary by Years of Experience, Education Level and Country
    ...
    experience_selected = st.selectbox("Select Experience Interval", experience_intervals)
    ...
    country_selected = st.selectbox('Select Your Country', countries)
    edu_level_selected = st.selectbox('Select Your Education Level', education_levels)
